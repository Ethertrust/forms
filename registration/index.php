...
<div id="colorbox" class="" role="dialog" tabindex="-1" style="display: block; visibility: visible; position: absolute; width: 480px; height: 464px; top: 50%; left: 50%; margin: -232px 0 0 -240px;  opacity: 1; cursor: auto;"><div id="cboxWrapper" style="text-align: left; height: 564px; width: 740px;"><div><div id="cboxTopLeft" style="float: left;"></div><div id="cboxTopCenter" style="float: left; width: 710px;"></div><div id="cboxTopRight" style="float: left;"></div></div><div style="clear: left;"><div id="cboxMiddleLeft" style="float: left; height: 539px;"></div><div id="cboxContent" style="float: left; width: 710px; height: 539px;"><div id="cboxLoadedContent" style="width: 710px; overflow: auto; height: 411px; position: absolute; top: 50%; left: 50%; margin: -255px 0 0 -355px;"><div id="webform" class="popup_form">
    <form class="webform-client-form" enctype="multipart/form-data" action="action2.php;inline=true" method="post" id="webform-client-form-56" accept-charset="UTF-8" novalidate="novalidate"><div>
        ...
        <div class="form-item webform-component webform-component-textfield" id="webform-component-studwork">
            <label for="edit-submitted-studwork">Место работы / учёбы <span class="form-required" title="Это поле обязательно для заполнения.">*</span></label>
            <input type="text" id="edit-submitted-studwork" name="submittedstudwork" value="" size="60" maxlength="128" class="form-text required" style="margin-top:2%; width:213px;">
            <label for="edit-submitted-studwork" id="error4" class="error" style="display: none;">заполните, пожалуйста</label>
        </div>
        <div class="form-item webform-component webform-component-textfield" id="webform-component-birthdate">
            <label for="edit-submitted-birthdate">Дата рождения <span class="form-required" title="Это поле обязательно для заполнения.">*</span></label>
            <input type="date" min="1920-01-01" id="edit-submitted-birthdate" name="submittedbirthdate" value="" size="60" maxlength="128" class="form-text required">
            <label for="edit-submitted-birthdate" id="error5" class="error" style="display: none;">заполните, пожалуйста</label>
        </div>
        <div class="form-item webform-component webform-component-textfield" id="webform-component-topic">
            <input type="hidden" id="edit-submitted-topic" name="topic" value="Запись on-line" size="60" maxlength="128">
        </div>
        <div class="form-actions form-wrapper" id="edit-actions"><input type="submit" id="edit-submit" name="op" value="Записаться on-line" class="form-submit"></div></div></form>			<a href="<?php echo $back; ?>" class="close_popup">Я передумал</a>
